      ...
      <aside className={styles.aside}>
        ...
        <ul className={styles.menus}>
          <li class="nav-item mb-4">
            <Link
              className={`{nav-link dropdown-toggle ${styles.toggles}`}
              id="navbarDropdown"
              role="button"
            ...
            <ul class="dropdown-menu py-0" aria-labelledby="navbarDropdown">
              <li className="mb-0">
                <Link to={"/seller/store"} class="dropdown-item">
                  Store profle
                </Link>
              </li>
            </ul>
          ...
          <li class="nav-item mb-4">
            ...
            >
              <div>
                ...
                >
                  ...
                  />
                  <path
                    d="M10.1802 12.64L16.0002 16.0067L21.8202 12.64"
                    stroke="white"
                    stroke-width="1.33333"
                    stroke-linecap="round"
                    stroke-linejoin="round"
            ...
            <ul class="dropdown-menu py-0" aria-labelledby="navbarDropdown">
              <li className="mb-0">
                <Link class="dropdown-item" to={"/seller/products"}>
                  My products
                </Link>
              </li>
              <li className="mb-0">
                <Link class="dropdown-item" to={"/seller/add-product"}>
                  Selling products
                </Link>
              </li>
            </ul>
          ...
          <li class="nav-item mb-4">
            ...
            <ul class="dropdown-menu py-0" aria-labelledby="navbarDropdown">
              <li className="mb-0">
                <Link class="dropdown-item" to={"/seller/orders"}>
                  My order
                </Link>
              </li>
              <li className="mb-0">
