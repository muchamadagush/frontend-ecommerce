    ...
    <>
      <div className={styles.contentBody}>
        ...
        <ul class={`nav`} id="pills-tab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <button className={`nav-link tab ${styles.myTabs}`} id="pills-sold-out-tab" data-bs-toggle="pill" data-bs-target="#pills-sold-out" type="button" role="tab" aria-controls="pills-sold-out" aria-selected="false">Get paid</button>
          </li>
          <li class="nav-item" role="presentation">
            <button className={`nav-link tab ${styles.myTabs}`} id="pills-processed-tab" data-bs-toggle="pill" data-bs-target="#pills-processed" type="button" role="tab" aria-controls="pills-processed" aria-selected="false">Processed</button>
          </li>
          <li class="nav-item" role="presentation">
