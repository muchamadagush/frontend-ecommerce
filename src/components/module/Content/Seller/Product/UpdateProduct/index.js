...
const UpdateProduct = () => {
  ...
  useEffect(() => {
    dispatch(fetchProduct(id)).then((res) => setData(res));
  ...
  for (let i = 0; i < formUpload.oldImage.length; i++) {
    imageViews.push(
      `${process.env.REACT_APP_API_URL}files/${formUpload.oldImage[i]}`
    );
  }
      ...
      <div className={styles.contentBody}>
        <form onSubmit={handleSubmitUpdate} enctype="multipart/form-data">
          <div className={styles.inventory}>
            ...
            <hr />
            <label htmlFor="title" class={`d-block ${styles.label}`}>
              Name of goods
            </label>
            <Input
              type="text"
          ...
          <div className={styles.itemDetails}>
            ...
            <Input
              ...
              actionChange={handleChange}
            />
            <label htmlFor="status" className={`d-block ${styles.label}`}>
              Status
            </label>
            <Input
              type="text"
              ...
              actionChange={handleChange}
            />
            <label htmlFor="categoryId" className={`d-block ${styles.label}`}>
              Category
            </label>
            <select
              name="categoryId"
            ...
            <div className="d-flex">
              <InputCheckbox
                ...
                isChecked={formUpload.type === "new" ? true : false}
              />{" "}
            ...
            <div className="d-flex">
              <InputCheckbox
                ...
                value="second"
                handleChange={handleChange}
                isChecked={formUpload.type === "second" ? true : false}
              />{" "}
          ...
          <div className={styles.photoOfGoods}>
              ...
              <div className={styles.containerThumbnail}>
                {formUpload.imagePreview.map((item) => (
                  <img
                    ...
                    alt="UploadedImage"
                    className={
                      item === formUpload.imagePreview[0]
                        ? styles.thumbnail
                        : styles.thumbnails
                    }
                  />
            ...
            <div className={styles.containerInputPhoto}>
              <label htmlFor="image" className={styles.labelUploadPhoto}>
                Upload Image
              </label>
              <input
                type="file"
